...
if(isset($_SESSION["st"]) && $_SESSION["st"] === true){
  ...
  header("location:/h_st/student/profile_st.php");
exit;
}elseif(isset($_SESSION["t"]) && $_SESSION["t"] === true){
  header("location:/h_st/teacher/profile_t.php");
...
?>
<!-- form start Teacher-->
				<form id="teacher" action="/h_st/connection/login.php" method="POST" class="login100-form validate-form flex-sb flex-w">
