...
if(isset($_SERVER['HTTP_REFERER'])){
	if(isset($_GET['err']) && $_GET['err'] == "wrongst"){
        echo  "<div id='mes' class='alert alert-danger alert-white rounded'>
                ...
                <strong>Error!</strong> Not a Registered Student!!!.
                </div>";
    }else if (isset($_GET['err']) && $_GET['err'] == "wrongstpass"){
        echo  "<div id='mes' class='alert alert-danger alert-white rounded'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true' id='cut'>×</button>
                <div class='icon'><i class='fa fa-times-circle'></i></div>
                <strong>Error!</strong> Wrong Password!!! Dear Student.
                </div>";
	...
	?>
<!-- form start Students-->
				<form id="student" action="/h_st/connection/login.php" method="POST" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input" data-validate = "Username is required">
						...
						<input class="input100" type="text" id="login" name="suser" placeholder="Student Username" required>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<input class="input100" type="password" id="password" name="spass" placeholder="Student password" required>
						<span class="focus-input100"></span>
					</div>

					<div class="container-login100-form-btn m-t-17">
						<button name="st_btn" value="Log In" class="login100-form-btn">
							Sign In
						</button>
					</div>
				</form>
				<div class="w-full text-center p-t-55">
					...
					<a href="teacherlog.php" class="txt2 bo1">
						Log In Here
					</a>
				</div>
<!-- form end Students-->
