      ...
      <div class="main-content">
        <section class="section">
          <div class="section-body">
            ...
            <h1>Assingments Assinged By Teachers :</h1>

<?php
$sql_sub = "SELECT * FROM `assingments` WHERE class = '$class_st' and section = '$sec_st'";
$result_sub = mysqli_query($conn,$sql_sub);
$no = mysqli_num_rows($result_sub);
if($no >= 1){
