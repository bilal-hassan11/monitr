...
$sql_st = "SELECT * FROM `students` where roll_no = '$sid'";
...
if (isset($_POST['open_paper'])) {
  ...
  $sub = $_POST['sub'];
  header('location:../parents/checkm.php?e='.$test_id.'&s='.$sub.'&ex_n='.$test_name.'');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
if($p_img == 1){
  echo  "<img id='profileImage' src='assets/img/parent.jfif' class='mobile_profile_image' alt='Please Uploaded Photo'>";
}else{
...
<?php
$sql_sub = "SELECT * FROM test_data WHERE class = '$class_st' and section = '$sec_st'";
...
while($sub = mysqli_fetch_assoc($result_sub)){
    ...
    $date = substr($date,0,10);
        echo  "<tbody>".
            ...
            "<th scope='row'>$i</th>".
            "<form method='post'>".
            "<td>"."<h6><input type='text' id='sub' name='sub' value='"."$Subject"."' readonly></h6>"."</td>".
            "<td>"."<h6>$section</h6>"."</td>".
            "<td>"."<h6>$class</h6>"."</td>".
