...
if(isset($_POST['view'])){
  ...
  WHERE a.class='$class' and a.section = '$sec' and s.class='$class' and s.section = '$sec' and a.roll_no='$roll_no' and a.dateTaken = '$dateTaken' and a.subject = '$sub_taken'";
  $rs = $conn->query($query);
  $num = mysqli_num_rows($rs);
  $sn=0;
  $status="";
  echo "<h2>Showing Attandence Of '$dateTaken of Subject : $sub_taken' :</h2>";
  if($num > 0)
  { 
