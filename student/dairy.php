...
<?php
$sql_sub = "SELECT `file`,`sub`,`dairy`,`class`,`section`,`date` FROM `dairy` WHERE class = '$class' and section = '$sec';";
...
while($row = mysqli_fetch_assoc($result_sub)){
  ...
  if($file !== 'none'){
    ...
    <u><h2>Subject:  $sub</h2></u>
        <h5>Dairy: $dairy</h5><textarea cols='50' rows='10'> $dairy </textarea>
        <h5>Class: $class</h5>
        <h5>Section: $sec</h5>
        <h5>Date: $date</h5>
        <h5>File:</h5>
    ...
    echo" <div class ='pdf'>
    <u><h2>Subject:  $sub</h2></u>
          <h5>Dairy: </h5><textarea cols='50' rows='10'> $dairy </textarea>
          <h5>Class: $class</h5>
          <h5>Section: $sec</h5>
          <h5>Date: $date</h5>
