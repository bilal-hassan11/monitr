      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="marks.php" class="nav-link"><i class="fas fa-book-open"></i><span>Marks</span></a>
            </li>
            <li class="dropdown">
...
<div class="info">
    ...
    <input type="text" id="" class="data_st" value=" <?php echo $roll_no;?>" placeholder="Enter Roll NO" readonly> <br>
    <label>
    Name
    <span id="req">*</span>
    </label>
    ...
    <input type="text" id="" class="data_st" value="<?php echo $class;?>" placeholder="Enter class" readonly> <br>
    <label>
    Section
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $sec;?>" placeholder="Enter Section" readonly> <br>
    <label>
    Email
    <span id="req">*</span>
    </label>
    ...
    <input type="text" id="" class="data_st" value="<?php echo $st_cnic;?>" placeholder="Enter Student CNIC"> <br>
    <label>
    Father Name
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $fname;?>" placeholder="Enter Father Name"> <br>
    <label>
    Father Occupation
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $st_f_occ;?>" placeholder="Enter Father Occupation"> <br>
    <label>
    Father CNIC
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $father_cnic;?>" placeholder="Enter Father CNIC"> <br>
    <label>
    Student Phone Number
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $st_phone;?>" placeholder="Enter Student Phone Number"> <br>
    <label>
    Father Phone Number
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $father_phone;?>" placeholder="Enter Father Number"> <br>
    <label>
    Current Address
    <span id="req">*</span>
    </label>
