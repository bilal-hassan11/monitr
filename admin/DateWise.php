...
<head>
  ...
  <title>Search Date Wise Fees</title>
  <!-- select 2 -->
         ...
         <ul class="sidebar-menu">
            ...
            <div class="collapse" id="form-fees">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                <a class="nav-link" href="DateWise.php"><i class="fas fa-chalkboard"></i><span>Date Wise Fees</span></a>
                </li>
             </ul>
            </div>
          </li>
                    ...
                    <table id="table_id_feetype" class="table table-striped table-hover">
                        <tbody>
                            ...
                            <div class="mb-2 mt-2">
                                ...
                                <input type="date" height="10px;" >
                            </div>
                                
                             <div class="col-3 ">
                                <label>Class Wise List : </label>
                                <select id="country" class="js-example-responsive" style="margin-right:10px;">
                                    <option value="">Selete Class</option>
                                </select>
                            </div>
                            <div class="col-4">
                                <label>Roll No Wise List : </label>
                                <select id="state" class="js-example-responsive">
