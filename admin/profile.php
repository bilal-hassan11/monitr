...
if(isset($_POST['submit_profile_info'])){
  ...
  $sql = "UPDATE `admin`
          SET `email` = '$email',`cnic` = '$cnic',`phone` = '$phone',`sec_phone` = '$sec_phone',`address` = '$address',`father_name` = '$fname' ,`p_address` = '$paddress'
          WHERE s_no = '$id'";
...
if(isset($_POST['passreset'])){
  ...
  $sql = "UPDATE `admin` SET `password` ='$newpass' WHERE `s_no` = '$id'";
  $result = mysqli_query($conn,$sql);
  }
  if($result){
...
<?php
    if($p_img == 1){
      echo  "<img id='profileImage' src='assets/img/admin.png' id='profile_image' alt='Please Uploaded Photo'>
       <form id='imgformmob' action='../profile_img/profileupload.php?id=$id' method='POST' enctype='multipart/form-data'>
       <input type='file' name='image' value='Upload Image' class='fileToUpload-btn'>
       <h3 id='text' >Maximum 1 MB</h3>
       <button class='fileToUpload' name='admin' class=''>Upload Profile</button>
       </form>";
}else{
...
?>
    ...
    <form action="" method="post">
        <span id="req">* This G-R Number is Auto System Genrated*</span><br>
    <label>
    G-R number
    </label>
    <input type="text" name="s_no" id="" class="data_st" value=" <?php echo $s_no;?>" placeholder="Enter Roll NO" readonly> <br>
    <label>
    Name
    <span id="req">*</span>
    </label>
    ...
    <input type="text" name="cnic" id="" class="data_st" value="<?php echo $cnic;?>" placeholder="Enter Student CNIC"> <br>
    <label>
    Father Name
    <span id="req">*</span>
    </label>
    ...
    <input type="text" name="phone" id="" class="data_st" value="<?php echo $phone;?>" placeholder="Enter Student Phone Number"> <br>
    <label>
    Current Address
    <span id="req">*</span>
    </label>
