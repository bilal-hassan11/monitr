...
<table>
  <thead>
   ...
   <?php
// to fetch Students--------------
$sql_student = "SELECT * from students s RIGHT join marksheet a on a.roll_no = s.roll_no WHERE a.exam_name = '$url_exam_name' and a.section = '$url_sec' and a.class = '$class' and s.section = '$url_sec' and s.class = '$class' and a.exam_id='$url_e_id' and a.subject = '$url_sub';";
