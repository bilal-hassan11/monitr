...
?>
<h1>Assined A Task :</h1>
<form action='../assingments/assingmentUpload.php?id=<?php echo $name;?>' method='POST' enctype='multipart/form-data'>
    <label>
    Title
    <span id="req">*</span>
    </label>
...
<?php
$sql_sub = "SELECT * FROM `assingments` WHERE class = '$class' and section = '$sec' and t_name = '$name'";
