...
while($row = mysqli_fetch_assoc($result_sub)){
        ...
        echo  "<tbody>".
            "<tr>".
            "<td scope='row'>$i</td>".
            // "<td><img src='$img' id='st_img' alt='no pic'></td>".
            "<td><img id='profileImage' src='assets/img/pic_girls.jpg' class='user-img-radious-style' alt='No Picture'></td>".
            "<td>"."$roll_no"."</td>".
            "<td>"."$name"."</td>".
            "<td>"."$sec"."</td>".
            "<td>"."$class"."</td>".
            "<td>"."<form method='post'>
            <input type='hidden' value='$roll_no' name='roll'>
            <input type='hidden' value='$sec' name='sec'>
            <input type='submit' class='btn' value='Open Profile' name='open_profile'>
            </form>".
            "</tr>";
            $i =$i +1;
    }
