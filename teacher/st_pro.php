...
<?php
  ...
  //  echo  "<img src='$user_image' id='profile_image' alt='Uploaded Photo'>";
   echo  "<img id='profile_image' src='assets/img/pic_girls.jpg' class='user-img-radious-style' alt='Uploaded Photo'>";
?>
</div>
...
<div class="info">
    ...
    <input type="text" id="" class="data_st" value="<?php echo $email;?>" placeholder="Enter Email" readonly> <br>
    <label>
    Father Name
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $fname;?>" placeholder="Enter Father Name" readonly> <br>
    <label>
    Father Phone Number
    <span id="req">*</span>
    </label>
    <input type="text" id="" class="data_st" value="<?php echo $father_phone;?>" placeholder="Enter Father Number" readonly> <br>
    <br>
    </div>
</div>
<br>
